...
def test_ship_it_counts_as_approval() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "Ship it. This disposition is ready.",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-18",
            "author_association": "MEMBER",
        }
    ]
...
def test_lgtm_with_not_yet_phrase_does_not_count() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "LGTM for direction, but not yet for closure until verifier reruns.",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-10",
            "author_association": "MEMBER",
        }
    ]
...
def test_ship_it_question_does_not_count() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "Ship it?",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-19",
            "author_association": "MEMBER",
        }
    ]
...
def test_ship_it_not_yet_does_not_count() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "Ship it later once the rerun lands.",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-20",
            "author_association": "MEMBER",
        }
    ]
...
def test_looks_good_to_me_keep_issue_open_does_not_count() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "Looks good to me to keep this issue open until we have one more verifier run.",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-28",
            "author_association": "MEMBER",
        }
    ]
...
def test_approved_for_investigation_does_not_count() -> None:
    issue = {
        "number": 939,
        "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939",
        "state": "open",
    ...
    comments = [
        {
            "user": {"login": "maintainer-a"},
            "body": "Approved to continue investigating provider drift before closure.",
            "html_url": "https://github.com/stranske/Travel-Plan-Permission/issues/939#issuecomment-29",
            "author_association": "MEMBER",
        }
    ]
